 ...
 */
public class Injected extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         View row=inflater.inflate(R.layout.fragment_defect, container, false);
    ...
    public void cargarInfomacion(){
        ...
        for (int i=0; i<fases.length;i++){
            Cursor cursor=db.cargarDefecLog(idProyecto+"",fases[i],null);
            if (cursor!=null){
